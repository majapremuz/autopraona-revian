...
export class ContentObject implements ContentInterface{
    ...
    constructor(data: ContentApiInterface){
        ...
        let moment = dateService.createMoment(data.content_create, 'dateTime',true,null);
        this.content_create = dateService.getString(moment);

        if(data.content_public_date != null){
            let moment = dateService.createMoment(data.content_public_date, 'dateTime',true,null);
            this.content_public_date = dateService.getString(moment);

        }else{
            this.content_public_date = null;
        }
