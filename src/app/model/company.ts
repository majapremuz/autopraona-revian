...
export class CompanyObject implements CompanyInterface{
    ...
    createDisplayAddress(){
        ...
        if(this.company_address != null){
            this.company_display_address = this.company_address;

            if(this.company_zip != null){
                this.company_display_address = this.company_display_address + ', ' + this.company_zip;
            }

            if(this.company_city != null){
                this.company_display_address = this.company_display_address + ', ' + this.company_city;
            }
        }
    }
}